...
data class FileId(
    ...
    companion object {
        ...
        const val DF_GRAPHICS = "5F50"
        const val EF_GRAPHICS_IMG = "4F20"
        const val EF_GRAPHICS_ICE = "4F21"
        const val DF_MULTIMEDIA = "5F3B"
        const val EF_MULTIMEDIA_MML = "4F47"
        const val EF_MULTIMEDIA_MMDF = "4F48"
        const val DF_MCS = "5F3D"
        const val EF_MCS_MST = "4F01"
        const val EF_MCS_CONFIG = "4F02"
        const val DF_V2X = "5F3E"
        const val EF_V2X_VST = "4F01"
        const val EF_V2X_CONFIG = "4F02"
        const val EF_V2X_POLICY_PC5 = "4F03"
        const val EF_V2X_POLICY_UU = "4F04"
        const val DF_A2X = "5F3F"
        const val EF_A2X_AST = "4F01"
        const val EF_A2X_CONFIG = "4F02"
        const val EF_A2X_POLICY_PC5 = "4F03"
        const val EF_A2X_DDAAP_PC5 = "4F04"
        const val EF_A2X_DC2P_PC5 = "4F05"
        const val EF_A2X_POLICY_UU = "4F06"
        ...
        const val DF_WLAN = "5F40"
        const val EF_WLAN_PSEUDO = "4F41"
        const val EF_WLAN_UPLMN = "4F42"
        const val EF_WLAN_OPLMN = "4F43"
        const val EF_WLAN_UWSIDL = "4F44"
        const val EF_WLAN_OWSIDL = "4F45"
        const val EF_WLAN_WRI = "4F46"
        const val EF_WLAN_HWSIDL = "4F47"
        const val EF_WLAN_WEHPLMNPI = "4F48"
        const val EF_WLAN_WHPI = "4F49"
        const val EF_WLAN_WLRPLMN = "4F4A"
        const val EF_WLAN_HPLMNDAI = "4F4B"
        ...
        const val EF_USIM_5GS_3GPP_LOCI = "4F01"
        const val EF_USIM_5GS_N3GPP_LOCI = "4F02"
        const val EF_USIM_5GS_3GPP_NSC = "4F03"
        const val EF_USIM_5GS_N3GPP_NSC = "4F04"
        const val EF_USIM_5GS_AUTH_KEYS = "4F05"
        const val EF_USIM_5GS_UAC_AIC = "4F06"
        const val EF_USIM_5GS_SUCI_CALC_INFO = "4F07"
        const val EF_USIM_5GS_OPL5G = "4F08"
        const val EF_USIM_5GS_SUPI_NAI = "4F09"
        const val EF_USIM_5GS_ROUTING_INDICATOR = "4F0A"
        const val EF_USIM_5GS_URSP = "4F0B"
        const val EF_USIM_5GS_TN3GPPSNN = "4F0C"
        const val EF_USIM_5GS_CAG = "4F0D"
        const val EF_USIM_5GS_SOR_CMCI = "4F0E"
        const val EF_USIM_5GS_DRI = "4F0F"
        const val EF_USIM_5GS_EDRX = "4F10"
        const val EF_USIM_5GS_NSWO_CONF = "4F11"
        const val EF_USIM_5GS_MCHPPLMN = "4F15"
        const val EF_USIM_5GS_KAUSF_DERIVATION = "4F16"

        const val EF_ISIM_IMPI = "6F02"
        const val EF_ISIM_DOMAIN = "6F03"
        const val EF_ISIM_IMPU = "6F04"
        const val EF_ISIM_ARR = "6F06"
        const val EF_ISIM_IST = "6F07"
        const val EF_ISIM_P_CSCF = "6F09"
        const val EF_ISIM_AC_GBAUAPI = "6F0A"
        const val EF_ISIM_IMSDCI = "6F0B"
        const val EF_ISIM_SMS = "6F3C"
        const val EF_ISIM_SMSP = "6F42"
        const val EF_ISIM_SMSS = "6F43"
        const val EF_ISIM_SMSR = "6F47"
        const val EF_ISIM_AD = "6FAD"
        const val EF_ISIM_GBABP = "6FD5"
        const val EF_ISIM_GBANL = "6FD7"
        const val EF_ISIM_NAFKCA = "6FDD"
        const val EF_ISIM_UICCIARI = "6FE7"
        const val EF_ISIM_FROMPREFERRED = "6FF7"
        const val EF_ISIM_IMS_CONFIG_DATA = "6FF8"
        const val EF_ISIM_WEBRTCURI = "6FFA"
        const val EF_ISIM_XCAP_CONFIG_DATA = "6FFC"
        const val EF_ISIM_MUDMID_CONFIG_DATA = "6FFE"
    }
