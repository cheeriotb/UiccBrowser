...
object EfDecoderRegistry {
    ...
    private val maps: Map<EfContext, Map<String, EfDecoder>> = mapOf(
        ...
        EfContext.USIM to mapOf(
            ...
            FileId.EF_USIM_ACM to UsimEfDecoders::decodeAcm,
            ...
            FileId.EF_USIM_ICI to UsimEfDecoders::decodeIci,
            FileId.EF_USIM_OCI to UsimEfDecoders::decodeOci,
            FileId.EF_USIM_ICT to UsimEfDecoders::decodeIct,
            FileId.EF_USIM_OCT to UsimEfDecoders::decodeOct,
            ...
            FileId.EF_USIM_IPS to UsimEfDecoders::decodeIps,
